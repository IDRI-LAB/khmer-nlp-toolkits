...
"""
import pytest
from src.commoncrawl.feature_cleaning import filter_kh_lng, check_quality_warning, is_adult_url_filter, remove_sentence_deduplicate
...
@pytest.mark.parametrize('exp_input, exp_output', [
    ...
    (
        [
            "(ផ្សាយឡើងវិញ) គោលនយោបាយ BRI បានរុញ ឡាវនិងកម្ពុជា ចេញផុតពីតារាវិថី នៃអំណាចឥទ្ធិពល របស់វៀតណាមសួស្ដីអ្នកទាំងអស់គ្នា",
            # "តេអេរ៉ង់៖ អ៊ីរ៉ង់នឹងស្វែងរកការសងសឹក ចំពោះការចោទប្រកាន់របស់អ៊ីស្រាអែលថា ការធ្វើឃាតប្រធានការិយាល័យ នយោបាយ",
        ],
        [
            "(ផ្សាយឡើងវិញ) គោលនយោបាយ BRI បានរុញ ឡាវនិងកម្ពុជា ចេញផុតពីតារាវិថី នៃអំណាចឥទ្ធិពល របស់វៀតណាម",
    ...
    (
        [
            "(ផ្សាយឡើងវិញ) គោលនយោបាយ BRI បានរុញ ឡាវនិងកម្ពុជា ចេញផុតពីតារាវិថី នៃអំណាចឥទ្ធិពល របស់វៀតណាមសួស្ដីអ្នកទាំងអស់គ្នាខ្ញុំគិតថាយើងតែខិតខំរៀនសូត្រនិងធ្វើការងារជាមួយគ្នា",
            "តេអេរ៉ង់៖ អ៊ីរ៉ង់នឹងស្វែងរកការសងសឹក ចំពោះការចោទប្រកាន់របស់អ៊ីស្រាអែលថា ការធ្វើឃាតប្រធានការិយាល័យ នយោបាយ",
        ],
        [
            "(ផ្សាយឡើងវិញ) គោលនយោបាយ BRI បានរុញ ឡាវនិងកម្ពុជា ចេញផុតពីតារាវិថី នៃអំណាចឥទ្ធិពល របស់វៀតណាម",
...
def test_remove_sentence_deduplicate(exp_input, exp_output):
    """
    clean data by remove duplicate sentence
    """
    output = remove_sentence_deduplicate(exp_input)
    print("exp_output", output)
    assert output == exp_output

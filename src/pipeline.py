...
class Pipeline:
    ...
    def __str__(self):
        ...
        for i, element in enumerate(self.info, 1):
    ...
    def add(self, step: Callable, **step_params):
        """
...
if __name__ == "__main__":
    ...
    # Add funcA to the pipeline with its parameters
    pipeline.add(funcA, is_upper=True)  # Pass `is_upper=True` to funcA

    # Add funcB to the pipeline with its parameters
    ...
    print(output_text)  # Output: HELLO WORLDHELLO WORLDHELLO WORLD
